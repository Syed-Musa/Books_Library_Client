...
const PopularBooksCard = ({popular}) => {
    const {popular_books_name, popular_books_image, author_name} = popular || {};

    return (
        <div className="ml-2">
            <div className="card w-96 bg-base-100 shadow-xl mb-10">
                <figure>
                    <img className="h-80" src={popular_books_image} alt="Shoes" />
                </figure>
                <div className="card-body">
                  <h2 className="font-bold"> {popular_books_name}</h2>
